...
public class DishController {
    ...
    public Result<DishVO> getById(@ApiParam(value = "菜品ID", required = true) @PathVariable Long id) {
        log.info("查询菜品: {}", id);
    ...
    @PutMapping()
    @ApiOperation("更新菜品信息")
    public Result update(@ApiParam(value = "菜品信息", required = true) @RequestBody DishDTO dishDTO) {
